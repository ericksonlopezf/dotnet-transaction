...
public sealed class ConnectionManipulationAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
    {
        ...
        var targetType = context.SemanticModel.GetTypeInfo(memberAccessExpr.Expression, context.CancellationToken).Type;
        if (targetType is not { Name: "DbConnection" } || targetType.ContainingNamespace?.ToDisplayString() != "System.Data.Common")
        {
            return;
        }
