...
public static class TransactionDiagnostics
{
    ...
    {
        StartedCounter.Add(1, new KeyValuePair<string, object?>("transaction.isolation_level", isolationLevel.ToString()));
    }
    ...
    {
        CommittedCounter.Add(1, new KeyValuePair<string, object?>("transaction.isolation_level", isolationLevel.ToString()));
        DurationHistogram.Record(durationMs, new KeyValuePair<string, object?>("transaction.outcome", "committed"));
    }
    ...
    {
        RolledBackCounter.Add(1, new KeyValuePair<string, object?>("transaction.isolation_level", isolationLevel.ToString()));
        DurationHistogram.Record(durationMs, new KeyValuePair<string, object?>("transaction.outcome", "rolled_back"));
    }
    ...
    {
        FailedCounter.Add(1,
            new KeyValuePair<string, object?>("transaction.isolation_level", isolationLevel.ToString()),
            new KeyValuePair<string, object?>("error.type", errorType ?? "Unknown"));
        DurationHistogram.Record(durationMs, new KeyValuePair<string, object?>("transaction.outcome", "failed"));
    }
