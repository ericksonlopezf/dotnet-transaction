...
/// <summary>
/// Provides classification methods for MariaDB error codes, deadlocks, lock wait timeouts, and transient connection failures.
/// </summary>
public static class MariaDbErrorClassifier
{
    ...
    private const int DuplicateKeyEntry = 1062;               // ER_DUP_ENTRY
    ...
    /// <summary>
    /// Determines whether the specified exception represents a MariaDB deadlock.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the specified exception represents a MariaDB lock wait timeout.
    /// </summary>
    /// <param name="exception">The exception to inspect, or <see langword="null"/>.</param>
